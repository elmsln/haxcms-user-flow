...
/* 
      ...
      .user-menu.open ::slotted(*:focus) {
        background-color: var(--app-hax-background-color-active, red); /* TODO: delete red later */
        color: var(--app-hax-background-color);
      }
  ...
  render() {
    return html`
      <div class="entireComponent">
        <div class="menuToggle" part="menuToggle" @click="${this.toggleMenu}" @keydown="${this.toggleMenu}">
