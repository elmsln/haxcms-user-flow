    ...
    return html`
      <div class="flex-container" id="infomation">
        ...
        <div class="flex-container" id="actions">
            <div class="info-group">
              <simple-icon-button-lite data-site="${this.siteId}" data-site-operation="publish" icon="editor:publish" id="dots" class="info-icon" @click=${this.siteOperation}>
                <div class="info-item">publish</div>
              </simple-icon-button-lite>
            </div>
            <div class="info-group">
              <simple-icon-button-lite data-site=${this.siteId} data-site-operation="copy" icon="content-copy" id="dots" class="info-icon" @click=${this.siteOperation}>
                <div class="info-item">copy</div>
              </simple-icon-button-lite>  
            </div>
            <div class="info-group">
              <simple-icon-button-lite data-site=${this.siteId} data-site-operation="download" icon="file-download" id="dots" class="info-icon" @click=${this.siteOperation}>
                <div class="info-item">download</div>
              </simple-icon-button-lite>
            </div>
            <div class="info-group">
              <simple-icon-button-lite data-site=${this.siteId} data-site-operation="delete" icon="delete-forever" id="dots" class="info-icon" @click=${this.siteOperation}>
