    ...
    return html`
      ...
      <div class="flex-container" id="infomation">
        ...
        <div class="flex-container" id="actions">
            <div class="info-group">
              <simple-icon-button-lite data-site=${this.siteId} data-site-operation="copySite" icon="content-copy" id="cp" class="info-icon" @click=${this.siteOperation}>
                <div class="info-item">copy</div>
              </simple-icon-button-lite>  
              <simple-tooltip for="cp" position="bottom">Copy site</simple-tooltip>
            </div>
            <div class="info-group">
              <simple-icon-button-lite data-site=${this.siteId} data-site-operation="downloadSite" icon="file-download" id="dl" class="info-icon" @click=${this.siteOperation}>
                <div class="info-item">download</div>
              </simple-icon-button-lite>
              <simple-tooltip for="dl" position="bottom">Download site</simple-tooltip>
            </div>
            <div class="info-group">
              <simple-icon-button-lite data-site="${this.siteId}" data-site-operation="archiveSite" icon="icons:archive" id="ar" class="info-icon" @click=${this.siteOperation}>
                <div class="info-item">archive</div>
              </simple-icon-button-lite>
              <simple-tooltip for="ar" position="bottom">Archive site</simple-tooltip>
            </div>
            <div class="info-group">
              <simple-icon-button-lite data-site=${this.siteId} data-site-operation="deleteSite" icon="delete-forever" id="del" class="info-icon" @click=${this.siteOperation}>
